...
namespace Shaders {
    ...
    unsigned int OpenGlShader::compileFragmentShaders()
    {
        ...
        return OpenGlShader::CompileShader(GL_FRAGMENT_SHADER, fragShaderSources[0]);
    }

    unsigned int OpenGlShader::LinkShader(unsigned int vertexShader, unsigned int fragmentShader)
    {
